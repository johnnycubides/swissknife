...
sed -e "s,<EXEC_LOCATION>,qucs,g" \
  -e "s,<ICON_LOCATION>,${SCRIPT_PATH}/qucs.png,g" "${SCRIPT_PATH}/linux/desktop.template" >"${TMP_DIR}/${RESOURCE_NAME}.desktop"
