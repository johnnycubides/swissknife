...
local default_shell = os.getenv("SHELL")
	or (PLATFORM == "Windows" and os.getenv("COMSPEC"))
	or (PLATFORM == "Windows" and "c:\\windows\\system32\\cmd.exe" or "sh")
local default_config = {
	...
	environment = {
		PWD = function()
			return core.root_project().path or USERDIR
		end,
	},
	...
	colors = {
		...
		[0] = { common.color("#000000") },
		[1] = { common.color("#aa0000") },
		[2] = { common.color("#44aa44") },
		[3] = { common.color("#aa5500") },
		[4] = { common.color("#0039aa") },
		[5] = { common.color("#aa22aa") },
		[6] = { common.color("#1a92aa") },
		[7] = { common.color("#aaaaaa") },
		[8] = { common.color("#777777") },
		[9] = { common.color("#ff8787") },
		[10] = { common.color("#4ce64c") },
		[11] = { common.color("#ded82c") },
		[12] = { common.color("#295fcc") },
		[13] = { common.color("#cc58cc") },
		[14] = { common.color("#4ccce6") },
		[15] = { common.color("#ffffff") },
		-- You can't customize these without repercussions.
		[16] = { common.color("#000000") },
		[17] = { common.color("#00005f") },
		[18] = { common.color("#000087") },
		[19] = { common.color("#0000af") },
		[20] = { common.color("#0000d7") },
		[21] = { common.color("#0000ff") },
		[22] = { common.color("#005f00") },
		[23] = { common.color("#005f5f") },
		[24] = { common.color("#005f87") },
		[25] = { common.color("#005faf") },
		[26] = { common.color("#005fd7") },
		[27] = { common.color("#005fff") },
		[28] = { common.color("#008700") },
		[29] = { common.color("#00875f") },
		[30] = { common.color("#008787") },
		[31] = { common.color("#0087af") },
		[32] = { common.color("#0087d7") },
		[33] = { common.color("#0087ff") },
		[34] = { common.color("#00af00") },
		[35] = { common.color("#00af5f") },
		[36] = { common.color("#00af87") },
		[37] = { common.color("#00afaf") },
		[38] = { common.color("#00afd7") },
		[39] = { common.color("#00afff") },
		[40] = { common.color("#00d700") },
		[41] = { common.color("#00d75f") },
		[42] = { common.color("#00d787") },
		[43] = { common.color("#00d7af") },
		[44] = { common.color("#00d7d7") },
		[45] = { common.color("#00d7ff") },
		[46] = { common.color("#00ff00") },
		[47] = { common.color("#00ff5f") },
		[48] = { common.color("#00ff87") },
		[49] = { common.color("#00ffaf") },
		[50] = { common.color("#00ffd7") },
		[51] = { common.color("#00ffff") },
		[52] = { common.color("#5f0000") },
		[53] = { common.color("#5f005f") },
		[54] = { common.color("#5f0087") },
		[55] = { common.color("#5f00af") },
		[56] = { common.color("#5f00d7") },
		[57] = { common.color("#5f00ff") },
		[58] = { common.color("#5f5f00") },
		[59] = { common.color("#5f5f5f") },
		[60] = { common.color("#5f5f87") },
		[61] = { common.color("#5f5faf") },
		[62] = { common.color("#5f5fd7") },
		[63] = { common.color("#5f5fff") },
		[64] = { common.color("#5f8700") },
		[65] = { common.color("#5f875f") },
		[66] = { common.color("#5f8787") },
		[67] = { common.color("#5f87af") },
		[68] = { common.color("#5f87d7") },
		[69] = { common.color("#5f87ff") },
		[70] = { common.color("#5faf00") },
		[71] = { common.color("#5faf5f") },
		[72] = { common.color("#5faf87") },
		[73] = { common.color("#5fafaf") },
		[74] = { common.color("#5fafd7") },
		[75] = { common.color("#5fafff") },
		[76] = { common.color("#5fd700") },
		[77] = { common.color("#5fd75f") },
		[78] = { common.color("#5fd787") },
		[79] = { common.color("#5fd7af") },
		[80] = { common.color("#5fd7d7") },
		[81] = { common.color("#5fd7ff") },
		[82] = { common.color("#5fff00") },
		[83] = { common.color("#5fff5f") },
		[84] = { common.color("#5fff87") },
		[85] = { common.color("#5fffaf") },
		[86] = { common.color("#5fffd7") },
		[87] = { common.color("#5fffff") },
		[88] = { common.color("#870000") },
		[89] = { common.color("#87005f") },
		[90] = { common.color("#870087") },
		[91] = { common.color("#8700af") },
		[92] = { common.color("#8700d7") },
		[93] = { common.color("#8700ff") },
		[94] = { common.color("#875f00") },
		[95] = { common.color("#875f5f") },
		[96] = { common.color("#875f87") },
		[97] = { common.color("#875faf") },
		[98] = { common.color("#875fd7") },
		[99] = { common.color("#875fff") },
		[100] = { common.color("#878700") },
		[101] = { common.color("#87875f") },
		[102] = { common.color("#878787") },
		[103] = { common.color("#8787af") },
		[104] = { common.color("#8787d7") },
		[105] = { common.color("#8787ff") },
		[106] = { common.color("#87af00") },
		[107] = { common.color("#87af5f") },
		[108] = { common.color("#87af87") },
		[109] = { common.color("#87afaf") },
		[110] = { common.color("#87afd7") },
		[111] = { common.color("#87afff") },
		[112] = { common.color("#87d700") },
		[113] = { common.color("#87d75f") },
		[114] = { common.color("#87d787") },
		[115] = { common.color("#87d7af") },
		[116] = { common.color("#87d7d7") },
		[117] = { common.color("#87d7ff") },
		[118] = { common.color("#87ff00") },
		[119] = { common.color("#87ff5f") },
		[120] = { common.color("#87ff87") },
		[121] = { common.color("#87ffaf") },
		[122] = { common.color("#87ffd7") },
		[123] = { common.color("#87ffff") },
		[124] = { common.color("#af0000") },
		[125] = { common.color("#af005f") },
		[126] = { common.color("#af0087") },
		[127] = { common.color("#af00af") },
		[128] = { common.color("#af00d7") },
		[129] = { common.color("#af00ff") },
		[130] = { common.color("#af5f00") },
		[131] = { common.color("#af5f5f") },
		[132] = { common.color("#af5f87") },
		[133] = { common.color("#af5faf") },
		[134] = { common.color("#af5fd7") },
		[135] = { common.color("#af5fff") },
		[136] = { common.color("#af8700") },
		[137] = { common.color("#af875f") },
		[138] = { common.color("#af8787") },
		[139] = { common.color("#af87af") },
		[140] = { common.color("#af87d7") },
		[141] = { common.color("#af87ff") },
		[142] = { common.color("#afaf00") },
		[143] = { common.color("#afaf5f") },
		[144] = { common.color("#afaf87") },
		[145] = { common.color("#afafaf") },
		[146] = { common.color("#afafd7") },
		[147] = { common.color("#afafff") },
		[148] = { common.color("#afd700") },
		[149] = { common.color("#afd75f") },
		[150] = { common.color("#afd787") },
		[151] = { common.color("#afd7af") },
		[152] = { common.color("#afd7d7") },
		[153] = { common.color("#afd7ff") },
		[154] = { common.color("#afff00") },
		[155] = { common.color("#afff5f") },
		[156] = { common.color("#afff87") },
		[157] = { common.color("#afffaf") },
		[158] = { common.color("#afffd7") },
		[159] = { common.color("#afffff") },
		[160] = { common.color("#d70000") },
		[161] = { common.color("#d7005f") },
		[162] = { common.color("#d70087") },
		[163] = { common.color("#d700af") },
		[164] = { common.color("#d700d7") },
		[165] = { common.color("#d700ff") },
		[166] = { common.color("#d75f00") },
		[167] = { common.color("#d75f5f") },
		[168] = { common.color("#d75f87") },
		[169] = { common.color("#d75faf") },
		[170] = { common.color("#d75fd7") },
		[171] = { common.color("#d75fff") },
		[172] = { common.color("#d78700") },
		[173] = { common.color("#d7875f") },
		[174] = { common.color("#d78787") },
		[175] = { common.color("#d787af") },
		[176] = { common.color("#d787d7") },
		[177] = { common.color("#d787ff") },
		[178] = { common.color("#d7af00") },
		[179] = { common.color("#d7af5f") },
		[180] = { common.color("#d7af87") },
		[181] = { common.color("#d7afaf") },
		[182] = { common.color("#d7afd7") },
		[183] = { common.color("#d7afff") },
		[184] = { common.color("#d7d700") },
		[185] = { common.color("#d7d75f") },
		[186] = { common.color("#d7d787") },
		[187] = { common.color("#d7d7af") },
		[188] = { common.color("#d7d7d7") },
		[189] = { common.color("#d7d7ff") },
		[190] = { common.color("#d7ff00") },
		[191] = { common.color("#d7ff5f") },
		[192] = { common.color("#d7ff87") },
		[193] = { common.color("#d7ffaf") },
		[194] = { common.color("#d7ffd7") },
		[195] = { common.color("#d7ffff") },
		[196] = { common.color("#ff0000") },
		[197] = { common.color("#ff005f") },
		[198] = { common.color("#ff0087") },
		[199] = { common.color("#ff00af") },
		[200] = { common.color("#ff00d7") },
		[201] = { common.color("#ff00ff") },
		[202] = { common.color("#ff5f00") },
		[203] = { common.color("#ff5f5f") },
		[204] = { common.color("#ff5f87") },
		[205] = { common.color("#ff5faf") },
		[206] = { common.color("#ff5fd7") },
		[207] = { common.color("#ff5fff") },
		[208] = { common.color("#ff8700") },
		[209] = { common.color("#ff875f") },
		[210] = { common.color("#ff8787") },
		[211] = { common.color("#ff87af") },
		[212] = { common.color("#ff87d7") },
		[213] = { common.color("#ff87ff") },
		[214] = { common.color("#ffaf00") },
		[215] = { common.color("#ffaf5f") },
		[216] = { common.color("#ffaf87") },
		[217] = { common.color("#ffafaf") },
		[218] = { common.color("#ffafd7") },
		[219] = { common.color("#ffafff") },
		[220] = { common.color("#ffd700") },
		[221] = { common.color("#ffd75f") },
		[222] = { common.color("#ffd787") },
		[223] = { common.color("#ffd7af") },
		[224] = { common.color("#ffd7d7") },
		[225] = { common.color("#ffd7ff") },
		[226] = { common.color("#ffff00") },
		[227] = { common.color("#ffff5f") },
		[228] = { common.color("#ffff87") },
		[229] = { common.color("#ffffaf") },
		[230] = { common.color("#ffffd7") },
		[231] = { common.color("#ffffff") },
		[232] = { common.color("#080808") },
		[233] = { common.color("#121212") },
		[234] = { common.color("#1c1c1c") },
		[235] = { common.color("#262626") },
		[236] = { common.color("#303030") },
		[237] = { common.color("#3a3a3a") },
		[238] = { common.color("#444444") },
		[239] = { common.color("#4e4e4e") },
		[240] = { common.color("#585858") },
		[241] = { common.color("#626262") },
		[242] = { common.color("#6c6c6c") },
		[243] = { common.color("#767676") },
		[244] = { common.color("#808080") },
		[245] = { common.color("#8a8a8a") },
		[246] = { common.color("#949494") },
		[247] = { common.color("#9e9e9e") },
		[248] = { common.color("#a8a8a8") },
		[249] = { common.color("#b2b2b2") },
		[250] = { common.color("#bcbcbc") },
		[251] = { common.color("#c6c6c6") },
		[252] = { common.color("#d0d0d0") },
		[253] = { common.color("#dadada") },
		[254] = { common.color("#e4e4e4") },
		[255] = { common.color("#eeeeee") },
	},
}
local function set_config_default_values(c)
	for _, v in ipairs(c) do
		if v.path then
			v.default = default_config[v.path]
		end
	end
	return c
end
...
if not config.plugins.terminal.bold_font then
	config.plugins.terminal.bold_font =
		config.plugins.terminal.font:copy(style.code_font:get_size(), { smoothing = true })
end
...
function TerminalView:get_name()
	return (self.modified_since_last_focus and "* " or "") .. (self.terminal and self.terminal:name() or "Terminal")
end
...
function TerminalView:shift_selection_update()
	...
	if shifts and not self.focused then
		self.modified_since_last_focus = true
	end
...
function TerminalView:spawn()
	self.terminal = terminal_native.new(
		self.columns,
		self.lines,
		self.options.scrollback_limit,
		self.options.term,
		self.options.shell,
...
function TerminalView:update()
	...
	if
		(self.last_font_size and self.last_font_size ~= self.options.font:get_size())
		or self.size.x > 0 and self.size.y > 0 and not self.terminal
		or self.last_size.x ~= self.size.x
		or self.last_size.y ~= self.size.y
	then
		self.columns =
			math.max(math.floor((self.size.x - self.options.padding.x * 2) / self.options.font:get_width("W")), 1)
		self.lines =
			math.max(math.floor((self.size.y - self.options.padding.y * 2) / self.options.font:get_height()), 1)
	...
	if self.terminal then
		...
		if exited == false then
			...
			if
				self.scrolling_offscreen
				and (
					not self.last_scroll_time
					or system.get_time() - self.last_scroll_time > self.options.scrolling_speed
				)
			then
...
function TerminalView:convert_color(int, target, should_bright)
	...
	elseif type == 2 then
		...
		if index < 8 and should_bright and (((attributes >> 3) & 0x1) ~= 0) then
			index = index + 8
		end
	...
	if self.terminal then
		...
		for line_idx, line in ipairs(self.terminal:lines()) do
			...
			if
				...
				and line_idx - 1 == cursor_y
				and self.terminal:scrollback() == 0
			then
				if mode == "blinking" then
			...
			for i = 1, #line, 2 do
				...
				foreground, text_style =
					self:convert_color(line[i] >> 32, "foreground", self.options.bold_text_in_bright_colors)

				if config.plugins.terminal.minimum_contrast_ratio > 0 then
					if not contrast_foreground[line[i]] then
						contrast_foreground[line[i]] =
							ensureContrastRatio(background, foreground, config.plugins.terminal.minimum_contrast_ratio)
					end
				...
				if selection then
					if
						((idx == selection[2] and selection[1] <= offset) or selection[2] < idx)
						and (selection[4] > idx or (idx == selection[4] and (selection[3] >= offset + length)))
					then -- overlaps all
						sections = { { foreground, background, text } }
					elseif
						idx == selection[2]
						and idx == selection[4]
						and selection[1] > offset
						and selection[3] < offset + length
					then -- overlaps in middle
						sections = {
							{ background, foreground, subfunc(text, 1, selection[1] - offset) },
							{ foreground, background, subfunc(text, selection[1] - offset + 1, selection[3] - offset) },
							{ background, foreground, subfunc(text, selection[3] - offset + 1, length) },
						}
					elseif
						(selection[2] < idx or (idx == selection[2] and selection[1] <= offset))
						and (idx == selection[4] and selection[3] < offset + length and selection[3] >= offset)
					then -- overlaps start
						sections = {
							{ foreground, background, subfunc(text, 1, selection[3] - offset) },
							{ background, foreground, subfunc(text, selection[3] - offset + 1, length) },
						}
					elseif
						(idx == selection[2] and selection[1] < offset + length and selection[1] >= offset)
						and (selection[4] > idx or (selection[4] == idx and selection[3] >= offset + length))
					then -- overlaps end
						sections = {
							{ background, foreground, subfunc(text, 1, selection[1] - offset) },
							{ foreground, background, subfunc(text, selection[1] - offset + 1, length) },
						}
					end
				end
						...
						if cursor_x >= local_offset and cursor_x < local_offset + len then
							...
							if cursor_x ~= local_offset then
								table.insert(
									sections,
									target,
									{ v[1], v[2], subfunc(v[3], 1, cursor_x - local_offset) }
								)
								target = target + 1
							end
							table.insert(
								sections,
								target,
								{ v[2], v[1], subfunc(v[3], cursor_x - local_offset + 1, cursor_x - local_offset + 1) }
							)
							target = target + 1
							if cursor_x ~= local_offset + len - 1 then
								table.insert(
									sections,
									target,
									{ v[1], v[2], subfunc(v[3], cursor_x - local_offset + 2) }
								)
							end
							break
						end
...
function TerminalView:on_mouse_moved(x, y, dx, dy)
	...
	if self.pressing or self.word_selecting or self.row_selecting then
		...
		local scrollback = self.terminal:scrollback()
		if not self.selection then
			self.selection = { col_approx, line - scrollback }
		end
		...
		elseif self.word_selecting then
			...
			if not col1 then
				...
				self.selection[4] = line - scrollback
			elseif
				self.word_selecting[2] > line1 or (self.word_selecting[2] == line1 and self.word_selecting[1] >= col1)
			then
...
function TerminalView:on_mouse_released(button, x, y)
	...
	if button == "left" then
		...
		if self.terminal:mouse_tracking_mode() == "normal" then
			self.terminal:input(
				"\x1B[M" .. string.char(32 + 3) .. string.char(32 + col + 1) .. string.char(32 + row + 1)
			)
...
function TerminalView:input(text)
	if self.terminal then
		...
		if self.terminal:scrollback() ~= 0 then
	...
	["terminal:scroll"] = function(view, amount)
		if view.terminal:mouse_tracking_mode() then
			...
			if view.terminal:mouse_tracking_mode() == "normal" then
				view.terminal:input(
					"\x1B[M"
						.. string.char(amount > 0 and 64 or 65)
						.. string.char(32 + col + 1)
						.. string.char(32 + row + 1)
				)
			elseif view.terminal:mouse_tracking_mode() == "sgr" then
				view.terminal:input(
					"\x1B[<" .. (amount > 0 and 64 or 65) .. ";" .. (col + 1) .. ";" .. (row + 1) .. "M"
				)
			end
		else
...
command.add(active_terminal_predicate, {
	["terminal:backspace"] = function(view)
		view:input(view.options.backspace)
	end,
	["terminal:ctrl-backspace"] = function(view)
		view:input(view.options.backspace == "\b" and "\x7F" or "\b")
	end,
	["terminal:alt-backspace"] = function(view)
		view:input("\x1B" .. view.options.backspace)
	end,
	["terminal:insert"] = function(view)
		view:input("\x1B[2~")
	end,
	["terminal:delete"] = function(view)
		view:input(view.options.delete)
	end,
	["terminal:return"] = function(view)
		view:input(view.options.newline)
	end,
	["terminal:enter"] = function(view)
		view:input(view.terminal:cursor_keys_mode() == "application" and "\x1BOM" or view.options.newline)
	end,
	["terminal:break"] = function(view)
		view:input("\x03")
	end,
	["terminal:eof"] = function(view)
		view:input("\x04")
	end,
	["terminal:suspend"] = function(view)
		view:input("\x1A")
	end,
	["terminal:tab"] = function(view)
		view:input("\t")
	end,
	...
	["terminal:page-up"] = function(view)
		view:input("\x1B[5~")
	end,
	["terminal:page-down"] = function(view)
		view:input("\x1B[6~")
	end,
	["terminal:scroll-up"] = function(view)
		view.terminal:scrollback(view.terminal:scrollback() + view.lines)
	end,
	["terminal:scroll-down"] = function(view)
		view.terminal:scrollback(view.terminal:scrollback() - view.lines)
	end,
	["terminal:scroll-to-end"] = function(view)
		view.terminal:scrollback(0)
	end,
	["terminal:scroll-to-top"] = function(view)
		view.terminal:scrollback(view.options.scrollback_limit)
	end,
	["terminal:up"] = function(view)
		view:input(view.terminal:cursor_keys_mode() == "application" and "\x1BOA" or "\x1B[A")
	end,
	["terminal:down"] = function(view)
		view:input(view.terminal:cursor_keys_mode() == "application" and "\x1BOB" or "\x1B[B")
	end,
	["terminal:left"] = function(view)
		view:input(view.terminal:cursor_keys_mode() == "application" and "\x1BOD" or "\x1B[D")
	end,
	["terminal:right"] = function(view)
		view:input(view.terminal:cursor_keys_mode() == "application" and "\x1BOC" or "\x1B[C")
	end,
	["terminal:jump-up"] = function(view)
		view:input("\x1B[1;5A")
	end,
	["terminal:jump-down"] = function(view)
		view:input("\x1B[1;5B")
	end,
	["terminal:jump-right"] = function(view)
		view:input("\x1B[1;5C")
	end,
	["terminal:jump-left"] = function(view)
		view:input("\x1B[1;5D")
	end,
	["terminal:home"] = function(view)
		view:input(view.terminal:cursor_keys_mode() == "application" and "\x1BOH" or "\x1B[H")
	end,
	["terminal:end"] = function(view)
		view:input(view.terminal:cursor_keys_mode() == "application" and "\x1BOF" or "\x1B[F")
	end,
	["terminal:f1"] = function(view)
		view:input("\x1BOP")
	end,
	["terminal:f2"] = function(view)
		view:input("\x1BOQ")
	end,
	["terminal:f3"] = function(view)
		view:input("\x1BOR")
	end,
	["terminal:f4"] = function(view)
		view:input("\x1BOS")
	end,
	["terminal:f5"] = function(view)
		view:input("\x1B[15~")
	end,
	["terminal:f6"] = function(view)
		view:input("\x1B[17~")
	end,
	["terminal:f7"] = function(view)
		view:input("\x1B[18~")
	end,
	["terminal:f8"] = function(view)
		view:input("\x1B[19~")
	end,
	["terminal:f9"] = function(view)
		view:input("\x1B[20~")
	end,
	["terminal:f10"] = function(view)
		view:input("\x1B[21~")
	end,
	["terminal:f11"] = function(view)
		view:input("\x1B[23~")
	end,
	["terminal:f12"] = function(view)
		view:input("\x1B[24~")
	end,
	["terminal:escape"] = function(view)
		view:input("\x1B")
	end,
	["terminal:start"] = function(view)
		view:input("\x13")
	end,
	["terminal:stop"] = function(view)
		view:input("\x11")
	end,
	["terminal:cancel"] = function(view)
		view:input("\x18")
	end,
	["terminal:start-of-heading"] = function(view)
		view:input("\x01")
	end,
	["terminal:start-of-text"] = function(view)
		view:input("\x02")
	end,
	["terminal:enquiry"] = function(view)
		view:input("\x05")
	end,
	["terminal:acknowledge"] = function(view)
		view:input("\x06")
	end,
	["terminal:bell"] = function(view)
		view:input("\x07")
	end,
	["terminal:vertical-tab"] = function(view)
		view:input("\x0B")
	end,
	["terminal:redraw"] = function(view)
		view:input("\x0C")
	end,
	["terminal:carriage-feed"] = function(view)
		view:input("\x0D")
	end,
	["terminal:shift-out"] = function(view)
		view:input("\x0E")
	end,
	["terminal:shift-in"] = function(view)
		view:input("\x0F")
	end,
	["terminal:data-line-escape"] = function(view)
		view:input("\x10")
	end,
	["terminal:history"] = function(view)
		view:input("\x12")
	end,
	["terminal:transpose"] = function(view)
		view:input("\x14")
	end,
	["terminal:negative-acknowledge"] = function(view)
		view:input("\x15")
	end,
	["terminal:synchronous-idel"] = function(view)
		view:input("\x16")
	end,
	["terminal:end-of-transmission-block"] = function(view)
		view:input("\x17")
	end,
	["terminal:end-of-medium"] = function(view)
		view:input("\x19")
	end,
	["terminal:file-separator"] = function(view)
		view:input("\x1C")
	end,
	["terminal:group-separator"] = function(view)
		view:input("\x1D")
	end,
	...
	["terminal:close-tab"] = function(view)
		view:close()
	end,
})
...
command.add(function()
	return core.active_view
		and core.active_view:is(TerminalView)
		and core.active_view.selection
		and #core.active_view.selection == 4
end, {
...
command.add(function()
	return core.terminal_view and core.active_view ~= core.terminal_view
end, {
...
core.status_view:add_item({
	...
	get_item = function()
		...
		return {
			style.text,
			style.font,
			(dv.terminal:name() or config.plugins.terminal.shell),
			style.dim,
			style.font,
...
for k, v in pairs(keys) do
	if config.plugins.terminal.omit_escapes == nil or not k:find(config.plugins.terminal.omit_escapes) then
		non_omitted_keys[k] = v
	end
end
	...
	for i = string.byte("a"), string.byte("z") do
		...
		for i, v in ipairs(keymap.map["ctrl+" .. string.char(i)] or {}) do
			if not v:find("terminal") then
				...
				commands["terminal:" .. v] = function(...)
					command.perform(v, ...)
				end
			end
		end
		if
			#keymaps > 0 and not keymap.map["ctrl+" .. config.plugins.terminal.inversion_key .. "+" .. string.char(i)]
		then
