...
-- START MY FUNTIONS --
local function move_focused_client_left_half()
...
local function move_focused_client_right_half()
	local c = client.focus
	if not c then
		return
	end
	local wa = c.screen.workarea
	local half_width = math.floor(wa.width / 2)
	c.floating = true
	c.maximized = false
	c.fullscreen = false
	c:geometry({
...
awful.layout.layouts = {
	...
	-- awful.layout.suit.corner.ne,nside rc.lua, look
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "n", function()
		awful.spawn("gnote")
	end, { description = "open gnote", group = "launcher" }),
	...
	end, { description = "open goldendict", group = "launcher" }),
